...
par(mfrow = c (2,2))
plot(input$DateTime,input$Global_active_power,type="l",xlab="",ylab="Global Active Power")
plot(input$DateTime,input$Voltage,type="l",xlab="datetime",ylab="voltage")

plot(input$DateTime,input$Sub_metering_1,xlab="",ylab="Energy sub metering",type="l")
...
plot(input$DateTime,input$Global_reactive_power,xlab="datetime",ylab="Global_reactive_power",type="l")
